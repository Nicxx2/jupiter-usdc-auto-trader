...
Security fixes are targeted at the current `v10.2.2` one-Compose baseline unless a newer supported release is published. Infrastructure images are pinned by tag and immutable digest; version or digest upgrades need separate compatibility and commissioning tests.
